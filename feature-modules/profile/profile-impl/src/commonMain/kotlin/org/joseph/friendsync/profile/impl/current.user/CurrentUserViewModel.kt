...
import org.joseph.friendsync.profile.impl.ProfileScreenEvent
import org.joseph.friendsync.profile.impl.ProfileUiState
...
class CurrentUserViewModel(
    ...
    init {
        screenModelScope.launchSafe(
            ...
            shouldCurrentUserFlowCommunication.emit(true)
            startFetchCurrentUser(currentUserId)
